...
- TC-02 SRC-UNV '국방부 법무관리관실 2025. 4. 31.자 유권해석' ← MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [gemini] 2월 30일, 4월 31일, 11월 31일 등 달력상 존재하지 않는 날짜가 판결일이나 유권해석일로 기재되어 있고 선고연도보
...
- TC-05 EVI-DATE '작성일 2026. 4. 31.' ← CASE_CITATION_ERROR: 날짜 불가능(INVALID_FORMAT): 대법원 2019. 2. 30. 선고 2018두47215
...
- TC-05 EVI-NUM '갑 제4호증 결번, 본문의 갑 제8호증 목록 누락' ← MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [anthropic] 4월 31일, 2월 30일처럼 존재하지 않는 날짜가 있습니다. CCTV 보고서(2.10.)가 사건일(2.13.)보다 
...
- TC-05 EVI-INCONS '병장/제1대대 ↔ 상병/제3대대' ← MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [anthropic] 진술서가 '같은 테이블'과 '약 3미터 떨어진 다른 테이블'을 함께 적고 있습니다. 계급(병장/상병)과 소속(제1대대
...
- TC-05 EVI-INCONS ''같은 테이블' ↔ '3미터 떨어진 다른 테이블'' ← MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [anthropic] 진술서가 '같은 테이블'과 '약 3미터 떨어진 다른 테이블'을 함께 적고 있습니다. 계급(병장/상병)과 소속(제1대대
...
- TC-05 EVI-OVR '진단서로 '원고가 무고하다는 사실' 입증' ← AI_AUTHORSHIP_LIKELY: AI 작성 참고 신호 문구 (내용 오류 판정 아님)
- TC-05 EVI-OVR '진단서로 '원고가 무고하다는 사실' 입증' ← MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [anthropic] 진술서가 '같은 테이블'과 '약 3미터 떨어진 다른 테이블'을 함께 적고 있습니다. 계급(병장/상병)과 소속(제1대대
...
- TC-02 [UNVERIFIED/C] MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [gemini] 2월 30일, 4월 31일, 11월 31일 등 달력상 존재하지 않는 날짜가 판결일이나 유권해석일로 기재되어 있고 선고연도보다 사건번호 연도가 앞서
...
- TC-05 [UNVERIFIED/C] MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [anthropic] 4월 31일, 2월 30일처럼 존재하지 않는 날짜가 있습니다. CCTV 보고서(2.10.)가 사건일(2.13.)보다 앞서고, 진술서(10.1
- TC-05 [UNVERIFIED/C] MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [anthropic] 진술서가 '같은 테이블'과 '약 3미터 떨어진 다른 테이블'을 함께 적고 있습니다. 계급(병장/상병)과 소속(제1대대/제3…)이 목록과 진술
- TC-06 [UNVERIFIED/C] MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [anthropic] 제소기간을 60일로 서술하면서 송달일 2026. 7. 8.부터 제소일 2026. 9. 24.까지 78일이 경과했는데도 적법하다고 결론지어, 
- TC-06 [UNVERIFIED/C] MODEL_FACT_REMARK: 모델이 지적한 사실 모순(재계산 대상): [gemini] 제소기간을 안 날부터 60일로 설시하면서 2026. 7. 8. 송달 후 2026. 9. 24. 소 제기(78일 경과)가 적법하다고 결론짓는 내부 
...
| TC-04 | AIGEN | 청구취지/청구원인 제목 | '### 청구취지', '**1. 사건의 개요**' | 1.0 | 시스템 판정 | [SUSPICIOUS/A] AI 응답 잔재(AI_RESPONSE_RESIDUE): 마크다운 문법 잔재 — '### 청구취지' |
...
| TC-05 | EVI-DATE | 갑 제3호증 | 작성일 2026. 4. 31. | 1.0 | 시스템 판정 | [CONTRADICTED/A] 증거 작성일이 달력에 없는 날짜다: 갑 제3호증 국방부 공문 (법무관리관-2026-0412) 작성일 2026. 4. 31. |
...
| TC-05 | EVI-FAKECIT | 갑 제7호증 | 대법원 2019. 2. 30. 선고 2018두47215 판결문 사본 | 1.0 | 시스템 판정 | [CONTRADICTED/A] 날짜 불가능(INVALID_FORMAT): 대법원 2019. 2. 30. 선고 2018두47215<br>[CONTRADICTED/A] 증거 작성일이 달력에 없는 날짜다: 갑 제3호증 국방부 공문 (법무관리관-2026-0412) 작성일 2026. 4. 31. |
